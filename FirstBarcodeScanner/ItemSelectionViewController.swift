...
class ItemSelectionViewController<Item: Equatable & RawRepresentable>: UITableViewController {
    ...
    init(delegate: ItemSelectionViewControllerDelegate, identifier: String, allItems: [Item], selectedItems: [Item], allowsMultipleSelection: Bool, allowsSelection: Bool) {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        tableView.allowsSelection = self.allowsSelection
